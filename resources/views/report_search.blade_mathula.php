    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <button type="button" id="multi_print" class="btn btn-primary " style="margin-left: 3px;border-radius: 10px;" >
                <span class="glyphicon glyphicon-print"></span> Multi Print
            </button>

            <button type="button" id="selected_single_print" class="btn btn-primary " style="margin-left: 3px;border-radius: 10px;" >
                <span class="glyphicon glyphicon-print"></span> Selected Single Print
            </button>
...
@push('script2')
    <script>
    // Single print select
    $(document).on('click','#selected_single_print',function (e) {
        e.preventDefault();
        // var occid =
        var select_col = [];
